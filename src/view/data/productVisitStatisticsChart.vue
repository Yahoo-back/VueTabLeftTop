	...
	<div>
        ...
        <div class="demo-input-suffix">
          ...
          <el-date-picker
			...
			<div id="visitChart" style="margin-top: 50px;width:100%;height:300px;"></div>
		</Card>
	</div>
...
export default {
	...
	mounted () {
		...
		const productVisitCharts = echarts.init(document.getElementById('visitChart'));
		productVisitCharts.setOption(options);
		window.addEventListener('resize', function () {
     	productVisitCharts.resize();
    });
	}
}
</script>