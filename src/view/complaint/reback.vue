          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-button @click="handleView" type="text" size="small">查看</el-button>
							<el-button @click="dialogRebackVisible = true" type="text" size="small" v-if="scope.row.refundstatus == 1 || scope.row.refundstatus == 4">退款</el-button>
            </template>
          </el-table-column>
        </el-table>
...
import * as table from './data/table';
  export default {
    ...
    methods:{
      ...
      handleView() {
        this.$router.push({ path:'/complaint/reback/rebackInfo'  })
      }
    },
    created(){
